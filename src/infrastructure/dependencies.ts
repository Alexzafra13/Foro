...
// Use Cases - Categories & Channels ✅ CORREGIDO
...
export class Dependencies {
  static async create() {
    ...
    const createComment = new CreateComment(commentRepository, postRepository, userRepository);
    ...
    const postController = new PostController(createPost, getPosts, getPostDetail, updatePost, deletePost);
